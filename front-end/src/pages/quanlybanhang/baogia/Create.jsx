...
const CreateBaoGia = () => {
    ...
    const onCreate = async () => {
        ...
        const res = await post("/QuanLyBanHang/donhang/baogia/add", payload, setIsLoading);
        if (res === true) {
            Swal.fire({
                title: "Thông báo!",
                text: "Báo giá tạo thành công !",
                icon: "success"
            })
            navigate(-1);
