                ...
                return (
                    <ActionBar
                        ...
                        buttons={[
                            {
                                label: "Quay lại",
                                onClick: () => navigate(`/QuanLyBanHang/HoaDonBan`),
                                icon: <ArrowBackIcon />,
                            },
                            {
                                label: "Đã Thanh Toán",
                ...
                <div className="w-full max-w-sm rounded-xl border border-slate-700/60 bg-slate-900/70 p-4">
                    ...
                    <div className="mt-4 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between text-slate-300">
                            ...
                            <span className="font-medium text-amber-400">{form.tongGTriDH}</span>
                        </div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="text-lg font-bold text-emerald-400">
                                {form.soLan > 1 ? 0 : form.tongGTriDH - form.soTienTra}
                            </span>
                        </div>
                    </div>
                </div>
